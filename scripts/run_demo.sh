...
CUDA_VISIBLE_DEVICE=2 python demo.py --model deeplabv3_resnet101_mapillary --save-folder ../model --dataset mapillary --input-pic ../datasets/mapillary/testing/images/04lBvvVWB6Vi33IjjQbzQA.jpg --out-dir /home/hufq/eval --repetition 1
