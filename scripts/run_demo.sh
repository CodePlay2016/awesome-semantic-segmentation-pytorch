...
CUDA_VISIBLE_DEVICE=2 python demo.py --model deeplabv3_resnet101_mapillary --save-folder ../model --dataset mapillary --input-pic /home/hufq/data/apollo_selected/171206_060208296_Camera_5.png --out-dir /home/hufq/eval --repetition 1
