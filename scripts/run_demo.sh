...
CUDA_VISIBLE_DEVICE=2 python demo.py --model deeplabv3_resnet101_mapillary --save-folder ../model --dataset mapillary --input-pic /home/hufq/data/leftImg8bit_trainvaltest/leftImg8bit/test/leftImg8bit_trainvaltes/berlin/berlin_000192_000019_leftImg8bit.png --out-dir /home/hufq/eval --repetition 1
