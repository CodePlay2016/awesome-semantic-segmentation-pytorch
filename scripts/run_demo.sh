...
CUDA_VISIBLE_DEVICE=2 python demo.py --model deeplabv3_resnet101_mapillary --save-folder ../model --dataset mapillary --input-pic ../datasets/mapillary/testing/images/KiGZ1nXOhNgOp6RrjED3AQ.jpg --out-dir /home/hufq/eval --repetition 1
